...
\co{The parallel algorithm has a logarithmic overhead when combined with an appropriate data structure}
...
\co{Different loss functions tailor sampling performance to different goals}
...
\co{Asymptotically dense sampling is achieved by adding subdomain volume to the loss}
