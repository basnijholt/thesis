...
The inclusion of the orbital effect modifies the phase diagram.
This is discussed in Ch.~\ref{ch:orbitalfield} which is in the weakly coupled superconductor limit, while Ch.~\ref{ch:shortjunction} discusses the strongly coupled superconductor limit.
