...
In most studies~\cite{Antipov2018,Winkler2019,Vuik2016,Nijholt2016,Winkler2017}, the superconducting order parameter $\Delta$ is assumed to be constant inside of the superconductor, even though an applied magnetic field might cause a spatial variation in both $\Delta$'s phase $\phi$ and amplitude.
...
Here, the orbital effect of magnetic field has to be treated properly which is done by the authors of \cite{Winkler2019,Wojcik2018}, as discussed earlier.
