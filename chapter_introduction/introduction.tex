...
This invariant can only assume $Q=+1$ (no Majoranas) and $Q=-1$ (Majoranas present) and changes when the band gap is closes and reopens.
...
With a topological band structure, we expect Majoranas to appear near the edges of the nanowires.
...
\section{Majoranas in a more realistic 3D hybrid nanowire}
