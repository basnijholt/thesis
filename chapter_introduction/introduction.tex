...
That means that after we exchange two Majoranas in space, the system looks exactly the same as it looked before the exchange.
...
% XXX: maybe explain H(k) = H + e^ik t + e^-ik t^\dagger
