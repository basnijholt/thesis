...
A full-scale three-dimensional simulation is beyond therefore beyond what is currently feasible.
Nevertheless, \cite{Antipov2018} simulates a slice of the proximitized nanowire.
It finds that disorder strongly affects important quantities such as the induced gap $\Delta_\textrm{ind}$, the critical field $B_\textrm{c}$, and their dependence on the external gate voltage.
