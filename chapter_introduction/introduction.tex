...
Physically, this choice corresponds to a limit where the total supercurrent $J_s$ is zero, appropriate for existing devices that use NbTiN as superconducting shell.
...
These devices are harder to simulate due to the large difference in the effective masses and Fermi energies between the semiconductor and the superconductor.
This means that the discretization in the superconductor has to be smaller than the Fermi wavelength of Al, ~$\SI{0.1}{\AA}$.
Additionally, because of the high density inside the superconductor, the wire can no longer be considered as symmetric with respect to the wire axis.
...
This minimization results in the correct vector potential and superconducting phase.
The inclusion of the orbital effect modifies the phase diagram shown in Fig.~\ref{fig:topo_bands}.
In Ch.~\ref{ch:orbitalfield}, we discuss the weakly coupled superconductor case while ~\cite{Wojcik2018} discusses the strongly coupled superconductor case.
...
Perfectly ordered crystalline solids are characterized by a faultlessly regular arrangement of their atoms in a crystal lattice, yet, these do not occur in nature. % https://onlinelibrary.wiley.com/doi/pdf/10.1002/anie.197004891
