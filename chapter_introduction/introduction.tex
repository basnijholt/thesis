...
Using the finite difference approximation, we can convert the linear ordinary differential equation, the continuous BdG Hamiltonian Eq.~\eqref{eq:3D_Ham}, into a system of equations described by a sparse matrix.
...
\co{Discretization of a Hamiltonian}
...
\co{We use the tight binding approximation and discretize the continuous BdG Hamiltonian on to a lattice.}
