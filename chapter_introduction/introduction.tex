...
Finally, the presence of a strong spin-orbit coupling is crucial to create Majoranas.
...
The k$\cdot$p perturbation theory models the spin-orbit coupling more accurately.
...
Finally, as Majorana device simulations start to include the spatially varying electric field into their models (as discussed earlier), it is crucial to understand how this affects the spin-orbit coupling, which can by using the k$\cdot$p theory.
