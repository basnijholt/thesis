...
Finally, the spectrum of a BdG Hamiltonian [Eq.~\eqref{eq:SC_spectrum}] is gapped around $E=0$, and since Majoranas live at zero energy, there are no nearby states in energy for the Majorana to decay to; this is the so-called topological protection. % XXX: Rephrase this and maybe move it.
