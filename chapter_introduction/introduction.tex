...
For example, the length of the physical nanowires are on the order of micrometers with a typical diameter of $\SI{100}{nm}$.
The Fermi wavelength $\lambda_\textrm{F}$ sets a lower limit on the lattice constant $a$, which is typically around $a=5-\SI{10}{nm}$ for the low density regime.
