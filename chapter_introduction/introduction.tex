...
We can also use the property that the gap always closes at either $k=0$ or $k=\pi$ ($E(k=\pi)=0$ does not occur in our model), however, we would still need to do many iterative solves of the eigenvalue problems to find where $E(k=0, B_x, \mu)=0$.
...
We essentially need to solve for the values of $\mu$ and $\psi$ in $H_\textrm{BdG}(\mu, k=0)\psi=0$.
