...
This problem is complex to study numerically because of the aforementioned high density differences, which means that the discretization in the superconductor has to be smaller than the Fermi wavelength of Al,~$\SI{0.1}{\AA}$.
...
\co{Other improvements include a better model for a proximitized superconductor, more accurate SOC with k.p, and including self-consistent electrostatics.}
...
An good understanding of how the metal gates influence the electrostatic potential, is therefore required to interpret both existing Majorana experiments and future improved Majorana devices.
...
\begin{enumerate}
\item Given the electronic density, solving the Poisson equation results in the electrostatic potential.
\item Given the electrostatic potential, solving the Schrödinger equation results in the energy spectrum and wave functions.
\item Finally, using that the bands fill according to the Fermi distribution, we get the electronic density.
\end{enumerate}
% This 
% The el
% To find the electrostatic potential, a self-consistent problem needs to be solved, iterating between 
% Initial studies Vuik2016: 10.1088/1367-2630/18/3/
