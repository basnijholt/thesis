...
One of these new states are ``topological insulators,'' which also exhibit edge or surface states and have similarities to the quantum Hall effect, but do not require extreme conditions such as the large magnetic field~\cite{Hasan2010}.  % XXX: add canonical reference
...
\caption{
Comparison of schematic representations and band structures of a normal insulator (left), quantum Hall effect (middle), and a topological insulator (right).
...
\begin{figure}
\begin{center}
\includegraphics[width=0.5\textwidth]{chapter_introduction/figures/phase_diagram_1D.pdf}
