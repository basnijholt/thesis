...
We now have all the terms in the Hamiltonian to create a topological band structure, which we calculate for an infinite system (i.e., system with a translation symmetry).
...
This wavefunction decays exponentially from both sides with a decay length $\xi$.
