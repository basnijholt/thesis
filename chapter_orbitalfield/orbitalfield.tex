...
\blfootnote{My contribution to this work is the writing of the paper, implementing the numerical methods, and performing the numerical simulations.}
...
The cyclotron radius becomes comparable to the typical wire diameters $d \sim \SI{100}{\nano\metre}$ already at the field of $\SI{0.3}{\tesla}$, and at a chemical potential corresponding to the optimal topological band gap.
