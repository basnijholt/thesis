...
We now turn to evaluate the consequences of the orbital effect of the magnetic field, known to strongly influence MBS properties~\cite{Lim2013, Osca2014, Osca2015, Nijholt2016}, in the short-junction limit.
This effect does not manifest in the model of Sec.~\ref{sec:1stmodel} when magnetic field points in the $x$ direction.
To include the orbital effect we use a thin shell approximation, when the electron wave function in the semiconductor is confined to its surface, similar to the system studied in Ref.~\cite{Osca2014}.
However unlike Ref.~\cite{Osca2014} we do not assume a constant induced gap and consider instead the nanowire contacted by a bulk superconductor, as shown in Fig.~\ref{fig:orb}.
...
\begin{figure}[tb]
\centering{\includegraphics[width=\columnwidth]chapter_shortjunction/figures/{orb}}
...
\centering{\includegraphics[width=\columnwidth]chapter_shortjunction/figures/{Borb}}
