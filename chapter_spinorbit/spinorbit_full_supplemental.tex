\documentclass[prl,singlecolumn,notitlepage,secnumroman,superscriptaddress,nobibnotes,graphicx,amsmath,amssymb]{revtex4-2}
...
\usepackage{hyperref}
\usepackage{xfrac}
%\usepackage[labelfont=bf,justification=justified]{caption} % Bold caption name
\hypersetup{
...
%   {\textbf{#1}}\@caption@fignum@sep#2
%}%
%\makeatother
%\renewcommand{\figurename}{Figure}
%\parskip 0pt
%
%\newenvironment{stretchtext}
...
\title{Supplemental Material: Spin-Orbit Protection of Induced Superconductivity in Majorana Nanowires} %Title of paper
