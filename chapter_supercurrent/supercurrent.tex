...
The result of a current biased measurement in this regime is shown in Fig.~\ref{fig:supercurrentZBP}(a), a very small (down to 1 pA) supercurrent could be resolved.
