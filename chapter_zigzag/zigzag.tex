...
\begin{figure}[!htb]
\centering
\includegraphics[width=0.9\columnwidth]{chapter_zigzag/figures/zigzag.pdf}
...
\begin{figure}[!htb]
\includegraphics[width=\columnwidth]{chapter_zigzag/figures/bandstructures}
...
\begin{figure}[!htb]
\includegraphics[width=\columnwidth]{chapter_zigzag/figures/wavefunctions}
...
\begin{figure}[!htb]
\includegraphics[width=\columnwidth]{chapter_zigzag/figures/phasediagrams}
...
\co{We calculate the topological phase diagram using the gap size.}
...
\co{The introduction of a the zigzag breaks a chiral symmetry, bringing the system from the BDI to the D symmetry class}
...
\co{The same principle applies to devices with only one superconductor.}
...
\begin{figure}[!htb]
\centering
\includegraphics[width=0.9\columnwidth]{chapter_zigzag/figures/phasediagrams_NS.pdf}
...
\co{Short trajectories are less sensitive to the alignment of magnetic field.}
...
\begin{figure}[!htb]
\centering
\includegraphics[width=0.9\columnwidth]{chapter_zigzag/figures/tilted_angle_phase_diagram.pdf}
...
\co{In a realistic device the magnetic field might not be inhomogeneous, but zigzag doesn't care.}

% \begin{figure}[!htb]
% \centering
% \includegraphics[width=0.9\columnwidth]{chapter_zigzag/figures/snaking_magnetic_field.pdf}
% \caption{
